...
class BorderT {
public:
  BorderT() : m_left(0), m_top(0), m_right(0), m_bottom(0) {}
  ...
  {
    return BorderT(m_left + value, m_top + value, m_right + value, m_bottom + value);
  }
  ...
  BorderT operator-() const { return BorderT(-m_left, -m_top, -m_right, -m_bottom); }
